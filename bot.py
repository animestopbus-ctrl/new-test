...
@BotInstance.on_message(filters.private & (filters.command(["save", "batch"]) | filters.regex(r"https?://t.me")))
async def save_handler(client: Client, message: Message):
    ...
    try:
        ...
        for msg_id in range(start, end + 1):
            ...
            if tg_msg.document and tg_msg.document.file_size > 2000000000:
